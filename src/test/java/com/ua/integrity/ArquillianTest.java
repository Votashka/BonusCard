...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "BonusProject";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "BonusProject.war")
            ...
            .addPackages(false, "com.ua.integrity") // not recursive to skip package 'nonarquillian'
